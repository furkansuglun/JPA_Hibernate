...
public class JoinTest {
	...
	public static void main(String[] args) {
		...
		List<Object[]> employeePhones = jpqlService.executeResultListQuery(JOIN_EMPLOYEE_AND_PHONE, Object[].class);

		for (Object[] phone : employeePhones) {
			System.out.println(phone[0] + "," + phone[1]);
		}

		// System.out.println("SELECT_ALL_PHONES_FROM_EMPLOYEE");
		// List<Phone2> phoneListFromEmployee =
		// jpqlService.executeResultListQuery(SELECT_ALL_PHONES_FROM_EMPLOYEE,
		// Phone2.class);
		//
		...
		// List<Department5> departmentFromEmployeeList =
		// jpqlService.executeResultListQuery(
		...
		// List<Department5> departmentProjectAddress =
		// jpqlService.executeResultListQuery(JOIN_DEPARTMENT_PROJECT_ADDRESS,
		// Department5.class);
		//
		...
		// List<Object[]> moreJoinList =
		// jpqlService.executeResultListQuery(MORE_JOIN, Object[].class);
		//
		...
		List<Object[]> aggFunctions = jpqlService.executeResultListQuery(AGGREGATE_FUNCTIONS, Object[].class);

		for (Object[] array : aggFunctions) {
			System.out.println(array[0] + " " + array[1] + " " + array[2] + " " + array[3] + " " + array[4]);
		}
		
		System.out.println("AVG_SALARY_GROUP_BY_DEPARTMENT");
		List<Object[]> avgSalary = jpqlService.executeResultListQuery(AVG_SALARY_GROUP_BY_DEPARTMENT, Object[].class);

		for (Object[] array : avgSalary) {
			System.out.println(array[0] + " " + array[1]);
		}

		System.out.println("AVG_SALARY_GROUP_BY_DEPARTMENT_HAVING");
		List<Object[]> havingBy = jpqlService.executeResultListQuery(AVG_SALARY_GROUP_BY_DEPARTMENT_HAVING, Object[].class , 51000);

		for (Object[] array : havingBy) {
			System.out.println(array[0] + " " + array[1]);
		}
		
		System.out.println("SELECT_EMPLOYEE_ORDER_BY_SALARY");
		List<Employee30> orderBy = jpqlService.executeResultListQuery(SELECT_EMPLOYEE_ORDER_BY_SALARY, Employee30.class);

		for (Employee30 employee : orderBy) {
			System.out.println(employee);
		}
