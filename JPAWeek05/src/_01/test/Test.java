...
public class Test {
	...
	public static void main(String[] args) {
		...
		List<Employee> employeeListNamedQuery = employeeDAO.findAllEmployeeByNamedQuery();
		for(Employee empList : employeeListNamedQuery) {
			System.out.println(empList);
		}
		
		//named query
		System.out.println("NAMED query by id \n");
		
		Employee foundById = employeeDAO.findEmployeeByIdNamedQuery(2);
		System.out.println(foundById);
		
		
		//named query
		System.out.println("constructor qujery employee details \n");
		List<EmployeeDetails> empDetails = employeeDAO.getEmployeeNameAndSalaryEmployeeDetails(); 
